  ...
  void _handleExportActivity(BuildContext context) async {
    ...
    final choice = await showDialog<String>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Choose a date range, or export all recorded activity.'),
        actions: [
          TextButton(
    ...
    await Printing.sharePdf(bytes: Uint8List.fromList(pdfBytes), filename: 'vulnera-activity-report.pdf');
  }
}